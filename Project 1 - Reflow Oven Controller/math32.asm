...
hex2bcd_L2_32:   
	...
	mov @r0, a
	inc r0
	djnz r1, hex2bcd_L2_32

	djnz r2, hex2bcd_L0_32
...
hex2bcd2_L2_32:
	...
	jb acc.7, hex2bcd2_L3_32 ; If the bcd digit was > 4 keep the correction
	add a, #(100h-30h)    ; Remove the correction to the MSD by subtracting 30h
hex2bcd2_L3_32:
	jb acc.3, hex2bcd2_L4_32 ; If the bcd digit was > 4 keep the correction
...
hex2bcd2_L4_32:
	...
	mov @r0, a
	inc r0
	djnz r1, hex2bcd2_L2_32
	
	djnz r2, hex2bcd2_L0_32
...
bcd2hex_L1_32:
	...
	jnb acc.7, bcd2hex_L2_32  ; test bit 7
	add a, #(100h-30h)     ; bit 7 is set. Perform correction by subtracting 30h.
bcd2hex_L2_32:
	jnb acc.3, bcd2hex_L3_32  ; test bit 3            
...
bcd2hex_L3_32:
	...
	djnz r1, bcd2hex_L1_32    ; repeat for all bcd pairs
...
bcd2hex_L4_32:
	...
	mov @r0, a
	dec r0
	djnz r1, bcd2hex_L4_32
	
	djnz r2, bcd2hex_L0_32
